...
const unsigned char char_types[] = {
    ...
    /*161     A1      ¡		*/ MARK_punct,
    /* Inverted exclamation mark */		      /* 0xa0 to 0xaf */
    ...
    /*193     C1     		*/ MARK_upper + MARK_vowel,
    /* Acute accent on capital A */				    /* 0xc0 to 0xcf */
    ...
    /*209     D1     		*/ MARK_upper + MARK_cons,
    /* Tilde accent on capital N */					/* 0xd0 to 0xdf */
    ...
    /*225     E1     		*/ MARK_vowel,
    /* Acute accent on lowercase a */	       /* 0xe0 to 0xef */
    ...
    /*241     F1     		*/ MARK_cons,
    /* Tilde accent on lowercase n */			   /* 0xf0 to 0xff */
...
unsigned int nchar_types[] = {
    ...
    /*161     A1      ¡		*/ TYPE2_null,
    /* Inverted exclamation TYPE2 */		       /* 0xa0 to 0xaf */
    ...
    /*193     C1     		*/ TYPE2_upper + TYPE2_vowel,
    /* Acute accent on capital A */				      /* 0xc0 to 0xcf */
