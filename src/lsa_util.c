...
void lsa_util_stress_gr(PLTS_T pLts_t, PHONE* fpp, PHONE* lpp, int pstype) {
	...
	if(lsa_util_pcmp(fpp, lpp, &excep_1[1], excep_1[0]) || lsa_util_pcmp(fpp, lpp, &excep_2[1], excep_2[0]) || lsa_util_pcmp(fpp, lpp, &excep_3[1], excep_3[0]))
		pLts_t->psyl = 1;
...
void lsa_util_stress_it(PLTS_T pLts_t, PHONE* fpp, PHONE* lpp, int pstype) {
	...
	if(lsa_util_pcmp(lpp->p_bp->p_bp, lpp, &excep_1[1], excep_1[0]) || lsa_util_pcmp(lpp->p_bp->p_bp, lpp, &excep_2[1], excep_2[0]))
...
void lsa_util_stress_sp(PLTS_T pLts_t, PHONE* fpp, PHONE* lpp, int pstype) {
	...
	pp = lpp->p_bp;
	if(lsa_util_pcmp(pp, lpp, &excep_1[1], excep_1[0]) || lsa_util_pcmp(pp, lpp, &excep_2[1], excep_2[0]) || lsa_util_pcmp(pp, lpp, &excep_3[1], excep_3[0]) || lsa_util_pcmp(pp, lpp, &excep_4[1], excep_4[0]))
		pLts_t->psyl = pLts_t->nsyl;
	else if(pLts_t->nsyl == 2 && lsa_util_pcmp(pp->p_bp, lpp, &excep_5[1], excep_5[0]))
		pLts_t->psyl = pLts_t->nsyl;
	else if(lsa_util_pcmp(pp->p_bp, lpp, &excep_6[1], excep_6[0]) || lsa_util_pcmp(pp->p_bp, lpp, &excep_7[1], excep_7[0]))
		pLts_t->psyl = pLts_t->nsyl - 2;
	else
		pLts_t->psyl = pLts_t->nsyl - 1;
