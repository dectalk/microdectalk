...
static void par_copy_index_list_cm_text(pindex_data_t dest_index,
								  int		    dest_pos,
...
static void par_copy_index_cm_text(pindex_data_t dest_index,
							 int		   dest_pos,
							 pindex_data_t src_index,
							 int		   src_pos)
{
...
static int par_is_index_set_cm_text(pindex_data_t indexes,
								int pos)
{
