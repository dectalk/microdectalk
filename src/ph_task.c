...
void ph_loop(LPTTS_HANDLE_T phTTS, unsigned short* input) {
	...
	{
		nextra = readphone(pKsd_t, (unsigned short*)buf, input);
		if(nextra == -1)
			return;
...
#endif
		/* debug eab */
		if(buf[0] == INDEX || buf[0] == INDEX_REPLY // tek 01aug97 bats 404 new msg types
		) {
...
#ifdef AD_BASE
				if(pDph_t->holdwordclass & FC_VERB || pDph_t->holdwordclass & FC_ED || pDph_t->holdwordclass & FC_BE || pDph_t->holdwordclass & FC_ING) {
					pDph_t->number_verbs++;
...
short* GetPhVdefParams(LPTTS_HANDLE_T phTTS, UINT index) {
	...
	switch(index) { // CAB Removed warnings by typecast
	case 0:
		memcpy(params, paul_8, sizeof(paul_8));
		break;
	case 1:
		memcpy(params, betty_8, sizeof(betty_8));
		break;
	case 2:
		memcpy(params, harry_8, sizeof(harry_8));
		break;
	case 3:
		memcpy(params, frank_8, sizeof(frank_8));
		break;
	case 4:
		memcpy(params, kit_8, sizeof(kit_8));
		break;
	case 5:
		memcpy(params, ursula_8, sizeof(ursula_8));
		break;
	case 6:
		memcpy(params, rita_8, sizeof(rita_8));
		break;
	case 7:
		memcpy(params, wendy_8, sizeof(wendy_8));
		break;
	case 8:
		memcpy(params, dennis_8, sizeof(dennis_8));
		break;
	case 9:
		memcpy(params, paul, sizeof(paul));
		break;
	case 10:
		memcpy(params, betty, sizeof(betty));
		break;
	case 11:
		memcpy(params, harry, sizeof(harry));
		break;
	case 12:
		memcpy(params, frank, sizeof(frank));
		break;
	case 13:
		memcpy(params, kit, sizeof(kit));
		break;
	case 14:
		memcpy(params, ursula, sizeof(ursula));
		break;
	case 15:
		memcpy(params, rita, sizeof(rita));
		break;
	case 16:
		memcpy(params, wendy, sizeof(wendy));
		break;
	case 17:
		memcpy(params, dennis, sizeof(dennis));
		break;
	}
	return params;
}
...
MMRESULT GetSpeakerParams(LPTTS_HANDLE_T phTTS, UINT uiIndex, SPDEFS** ppspCur,
	...
	*ppspDefault = (SPDEFS*)malloc(sizeof(SPDEFS));
	...
	if(pKsd_t->uiSampleRate < 8763) /* 8-bit */
		switch(speaker_num) {	// CAB Removed warnings by typecast
		case 0:
			cur_speaker = (short*)paul_8;
			break;
		case 1:
			cur_speaker = (short*)betty_8;
			break;
		case 2:
			cur_speaker = (short*)harry_8;
			break;
		case 3:
			cur_speaker = (short*)frank_8;
			break;
		case 4:
			cur_speaker = (short*)dennis_8;
			break;
		case 5:
			cur_speaker = (short*)kit_8;
			break;
		case 6:
			cur_speaker = (short*)ursula_8;
			break;
		case 7:
			cur_speaker = (short*)rita_8;
			break;
		case 8:
			cur_speaker = (short*)wendy_8;
			break;
		}
	else			      /* 16-bit */
		switch(speaker_num) { // CAB Removed warnings by typecast
		case 0:
			cur_speaker = (short*)paul;
			break;
		case 1:
			cur_speaker = (short*)betty;
			break;
		case 2:
			cur_speaker = (short*)harry;
			break;
		case 3:
			cur_speaker = (short*)frank;
			break;
		case 4:
			cur_speaker = (short*)dennis;
			break;
		case 5:
			cur_speaker = (short*)kit;
			break;
		case 6:
			cur_speaker = (short*)ursula;
			break;
		case 7:
			cur_speaker = (short*)rita;
			break;
		case 8:
			cur_speaker = (short*)wendy;
			break;
		}
	// #endif
