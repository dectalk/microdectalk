...
import static dev.bytesizedfox.microdectalktest.App.writeTextFile;
...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    public boolean onOptionsItemSelected( @NonNull MenuItem item ) {
        ...
        if (id == R.id.share || id == R.id.export) {
            ...
            App.TextToSpeechSetRate( 180 + ((App.rate-50)*2) );
            samples = App.TextToSpeechStart(text, false);
        }
        if (id == R.id.share) {
            try {
        ...
        if (id == R.id.SaveText) { // save the text to a file
            File textFile = null;
            try {
        ...
        if (this.voiceList.contains(item.getTitle().toString().toLowerCase())) {
            ...
            App.TextToSpeechChangeVoice(nameToNameCode(name));
    ...
    private void initSettings() {
        ...
        voiceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                App.TextToSpeechChangeVoice(nameToNameCode(voiceID));
