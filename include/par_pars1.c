...
void par_match_rule(unsigned char *current_rule,
					...
					preturn_value_t ret_value,
					int dict_state_flag);
static void par_copy_index(pindex_data_t dest_index,
							 int		   dest_pos,
							 pindex_data_t src_index,
							 int		   src_pos);
static void par_copy_index_list(pindex_data_t dest_index,
								  int		   dest_pos,
								  pindex_data_t src_index,
								  int		   src_pos,
								  int		   length);
static int par_is_index_set(pindex_data_t indexes,
								int pos);
static void par_set_return_level(int *return_rule,
								   int *return_level,
								   int go_rule);
static int par_get_return_level(int *return_rule,
									int *return_level,
...
preturn_value_t par_process_input(PKSD_T pKsd_t,
								  ...
								  pmatch_arrays_t match_array,
                                  preturn_value_t ret_value);
static void par_initialize_arrays(pmatch_arrays_t match_arrays);
